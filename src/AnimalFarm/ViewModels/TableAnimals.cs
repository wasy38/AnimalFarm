    ...
    class TableAnimals : BaseViewModel
    {
        ...
        public TableAnimals()
        {
            ...
            CreateAnimal = new RelayCommand(obj =>
            {
                ...
                //Add place
                newAnimalPlace = new() { PlaceId = FarmContext._context.Places.Where(x => x.Name == sellectedPlace).FirstOrDefault().Id, AnimalId = newAnimal.Id, Lease = DateTime.Now };
